...
>
    ...
    <header class="w-full sticky inset-x-0 flex pb-[5px] pt-[5px] top-0 z-10 bg-white border-b " >
        ...
        <div class="flex w-full items-center px-2 lg:px-4 gap-2 md:gap-5">
           ...
           {{-- @dd($selectedConversation->getReceiver()); --}}
            ...
            <div class="max-w-xl mx-auto bg-white rounded-lg overflow-hidden shadow-lg">
                ...
                <div class="border-b px-8">
                    <div class="text-center sm:text-left sm:flex mb-1">
                        ...
                        <div class="py-2">
                            <h3 class="font-bold text-2xl mb-1">{{$selectedConversation->getReceiver()->name}}</h3>
                            ...
                            <div class="flex items-center text-grey-darker mb-4">
                                ...
                                <span><strong class="h-5 w-5 text-gray-600 mr-1">Joined </strong>{{ $selectedConversation->getReceiver()->created_at->diffForHumans() }}</span>
                            </div>
                        </div>
                    </div>
                </div>
